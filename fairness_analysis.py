...
if __name__ == "__main__":
    ...
    if data_name == "census":
        ...
        data_addr = "data/CFA-Synthetic/test-synthetic-1000-1.csv"
    elif data_name == "synthetic2":
        data_addr = "data/CFA-Synthetic/test-synthetic-1000-2.csv"
    elif data_name == "synthetic3":
        data_addr = "data/CFA-Synthetic/test-synthetic-1000-3.csv"
